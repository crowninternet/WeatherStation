...
INSTALLER_URL="https://raw.githubusercontent.com/crowninternet/WeatherStation/main/proxmox/fresh-install-v6.sh"
...
echo "curl -fsSL https://raw.githubusercontent.com/crowninternet/WeatherStation/main/proxmox/fresh-install-v6.sh | bash"
echo ""
print_info "Or download first:"
echo "wget https://raw.githubusercontent.com/crowninternet/WeatherStation/main/proxmox/fresh-install-v6.sh"
echo "chmod +x fresh-install-v6.sh"
echo "./fresh-install-v6.sh"
echo ""
